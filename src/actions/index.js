...
export const startFetchHeadline = ()=>{
    const HEADLINE_URL = `https://newsapi.org/v2/top-headlines?sources=crypto-coins-news&apiKey=c8ef108467b646219b3b8c85488ab725`;
...
export const startFetchArticle = ()=>{
    ...
    const ARTICLE_URL = `https://newsapi.org/v2/everything?sources=crypto-coins-news&apiKey=c8ef108467b646219b3b8c85488ab725`;
